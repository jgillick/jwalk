...
// #/string_id_map#
    ...
    {
        int c;
        sourceCommentStart = -1;
        sourceCommentLineno = -1;
    retry:
        for (;;) {
            ...
            case '/':
                // is it a // comment?
                if (matchChar('/')) {
                	if(sourceCommentStart == -1){
	                	sourceCommentStart = sourceCursor - 1;
	                	sourceCommentLineno = lineno;
                	}
                    skipLine();
                    continue retry;
                }
     ...
     */
    public void readRegExp(int startToken) // <jgillick>
        throws IOException
    {
        stringBufferTop = 0;
    ...
    // <jgillick>
    public final int getCommentStart(){
    	return sourceCommentStart;
    }
    // <jgillick>
    public final int getCommentLineno(){
    	return sourceCommentLineno;
    }
    ...
    private int sourceTokenStart; // <jgillick>
    private int sourceCommentStart; // <jgillick>
    private int sourceCommentLineno; // <jgillick>
