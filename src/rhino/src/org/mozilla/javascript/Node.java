...
public class Node
{
    ...
    */
    ...
    private static class StringNode extends Node
    {
    	...
    	// <jgillick>
    	StringNode(int type, String str, int lineno, int offset) {
    		super(type, lineno, offset);
            this.str = str;
    	}
    ...
    public static class Jump extends Node
    {
        ...
        Jump(int type, int lineno, int offset) // <jgillick>
        {
            super(type, lineno, offset);
        }
        ...
        Jump(int type, Node child, int lineno, int offset) // <jgillick>
        {
            super(type, child, lineno, offset);
        }
    ...
    static class Scope extends Jump {
        ...
        public Scope(int nodeType, int lineno, int offset) { // <jgillick>
            super(nodeType, lineno, offset); // <jgillick>
        }

        public Scope(int nodeType, Node n, int lineno, int offset) { // <jgillick>
            super(nodeType, n, lineno, offset); // <jgillick>
        }
    ...
    public Node(int nodeType, int line, int offset) { // <jgillick>
        type = nodeType;
        lineno = line;
        this.offset = offset; // <jgillick>
    }

    public Node(int nodeType, Node child, int line, int offset) { // <jgillick>
        this(nodeType, child);
        lineno = line;
        this.offset = offset; // <jgillick>
    }

    public Node(int nodeType, Node left, Node right, int line, int offset) { // <jgillick>
        this(nodeType, left, right);
        lineno = line;
        this.offset = offset; // <jgillick>
    }

    public Node(int nodeType, Node left, Node mid, Node right, int line, int offset) { // <jgillick>
    ...
    // <jgillick>
    public static Node newString(int type, String str, int lineno, int offset) {
    	Node node = new StringNode(type, str, lineno, offset);
        return node;
    }
    ...
    /** <jgillick> Returns the location in the source that this node begins */
    public int getOffset(){
    	return offset;
    }

    /** <jgillick> Returns the location in the source that this node begins */
    protected void setOffset(int pos){
    	offset = pos;
    }
    ...
    protected int offset = -1; // <jgillick>
