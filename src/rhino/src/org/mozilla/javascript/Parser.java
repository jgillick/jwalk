...
// end of per function variables
    ...
    {
        Node loop = nf.createLoopNode(loopLabel, ts.getLineno(), ts.getTokenStart()); // <jgillick>
        if (loopSet == null) {
    ...
    private Node enterSwitch(Node switchSelector, int lineno, int offset) // <jgillick>
    {
        Node switchNode = nf.createSwitch(switchSelector, lineno, offset);
        if (loopAndSwitchSet == null) {
            loopAndSwitchSet = new ObjArray();
        }
    ...
    {
        ++nestingOfFunction;
        Node pn = nf.createBlock(ts.getLineno(), ts.getTokenStart()); // <jgillick>
        try {
            bodyLoop: for (;;) {
                Node n;
                int tt = peekToken();
        ...
        throws IOException, ParserException
    {
        ...
        int baseLineno = ts.getLineno();  // line number where source starts
        int basePosition = ts.getTokenStart(); // <jgillick>
        ...
        try {
            ...
            if (destructuring != null) {
                body.addChildToFront(
                    new Node(Token.EXPR_VOID, destructuring, ts.getLineno(), ts.getTokenStart())); // <jgillick>
            }
        ...
        fnNode.setOffset(basePosition);  // <jgillick>
        ...
        if (memberExprNode != null) {
            ...
            if (functionType != FunctionNode.FUNCTION_EXPRESSION) {
                ...
                pn = nf.createExprStatementNoReturn(pn, baseLineno, basePosition); // <jgillick>
            }
        }
        return pn;
    }
    ...
    private Node statements(Node scope)
        throws IOException
    {
        Node pn = scope != null ? scope : nf.createBlock(ts.getLineno(), ts.getTokenStart()); // <jgillick>
        ...
        throws IOException
    {
        ...
        int position = ts.getTokenStart();  // <jgillick>
        ...
        return nf.createExprStatement(nf.createName("error"), lineno, position); // <jgillick>
    }
        ...
        throws IOException, ParserException
    {
        ...
        switch (tt) {
          case Token.IF: {
            ...
            pn = nf.createIf(cond, ifTrue, ifFalse, lineno, position); // <jgillick>
            return pn;
          }
          ...
          case Token.SWITCH: {
            ...
            decompiler.addToken(Token.LP);
            pn = enterSwitch(expr(false), lineno, ts.getTokenStart()); // <jgillick>
            try {
          ...
          case Token.TRY: {
            ...
            pn = nf.createTryCatchFinally(tryblock, catchblocks,
                                          finallyblock, lineno, position); // <jgillick>
          ...
          case Token.THROW: {
            ...
            pn = nf.createThrow(expr(false), lineno, position); // <jgillick>
            break;
          }
          ...
          case Token.BREAK: {
            ...
            pn = nf.createBreak(breakStatement, lineno, position); // <jgillick>
            break;
          }
          ...
          case Token.CONTINUE: {
            ...
            pn = nf.createContinue(loop, lineno, position); // <jgillick>
            break;
          }
          ...
          case Token.WITH: {
            ...
            pn = nf.createWith(obj, body, lineno, position); // <jgillick>
            return pn;
          }
          ...
          case Token.DEBUGGER:
            ...
            pn = nf.createDebugger(ts.getLineno(), ts.getTokenStart()); // <jgillick>
            break;
          ...
          case Token.LC:
            ...
            Node scope = nf.createScopeNode(Token.BLOCK, ts.getLineno(), ts.getTokenStart()); // <jgillick>
            pushScope(scope);
            try {
                statements(scope);
          ...
          case Token.DEFAULT :
            ...
            int nsPosition = ts.getTokenStart(); // <jgillick>
            ...
            pn = nf.createDefaultNamespace(expr, nsLine, nsPosition); // <jgillick>
            break;
          ...
          case Token.NAME: {
            ...
            if (pn.getType() != Token.LABEL) {
                pn = nf.createExprStatement(pn, lineno, position); // <jgillick>
            } else {
        ...
        throws IOException, ParserException
    {
        ...
        if (tt == Token.RETURN) {
            ...
            ret = nf.createReturn(e, lineno, position); // <jgillick>
            ...
            ret = nf.createYield(e, lineno, position); // <jgillick>
            if (!exprContext)
                ret = new Node(Token.EXPR_VOID, ret, lineno, position); // <jgillick>
        }
    ...
    private Node variables(boolean inFor, int declType)
        throws IOException, ParserException
    {
        Node result = nf.createVariables(declType, ts.getLineno(), ts.getTokenStart()); // <jgillick>
        boolean first = true;
        for (;;) {
            Node destructuring = null;
            String s = null;
        ...
        throws IOException, ParserException
    {
        ...
        decompiler.addToken(Token.LP);
        Node result = nf.createScopeNode(Token.LET, ts.getLineno(), ts.getTokenStart()); // <jgillick>
        pushScope(result);
        try {
              ...
              if (isStatement && peekToken() == Token.LC) {
                  ...
                  if (isStatement) {
                      ...
                      result = nf.createExprStatement(result, ts.getLineno(), ts.getTokenStart()); // <jgillick>
                  }
              }
        } finally {
            popScope();
        ...
        for (;;) {
            ...
            switch (tt) {
              ...
              case Token.DOTQUERY:
                ...
                pn = nf.createDotQuery(pn, expr(false), ts.getLineno(), ts.getTokenStart()); // <jgillick>
        ...
        throws IOException, ParserException
    {
        ...
        pn = nf.createPropertyGet(pn, namespace, name, memberTypeFlags, ts.getLineno(), ts.getTokenStart()); // <jgillick>
        return pn;
    }
        ...
        throws IOException, ParserException
    {
        ...
        if (tt == Token.FOR) {
            ...
            body = new Node(Token.EXPR_VOID, call, ts.getLineno(), ts.getTokenStart()); // <jgillick>
            if (tt == Token.IF) {
                consumeToken();
                decompiler.addToken(Token.IF);
                int lineno = ts.getLineno();
                int position = ts.getTokenStart(); // <jgillick>
                Node cond = condition();
                body = nf.createIf(cond, body, null, lineno, position); // <jgillick>
            }
            ...
            for (;;) {
                           ...
                           tt == Token.FOR)
                {
                    ...
                    try {
                        ...
                        Node block = nf.createBlock(ts.getLineno(), ts.getTokenStart()); // <jgillick>
                        Node init = new Node(Token.EXPR_VOID,
                            nf.createAssignment(Token.ASSIGN,
                                nf.createName(tempName),
                                nf.createCallOrNew(Token.NEW,
                                    nf.createName("Array"))), ts.getLineno(), ts.getTokenStart()); // <jgillick>
                ...
                do {
                    ...
                    switch(tt) {
                      ...
                      case Token.STRING:
                        ...
                        property = ScriptRuntime.getIndexObject(s);
                        plainProperty(elems, property, ts.getLineno(), ts.getTokenStart());
                        break;
          ...
          case Token.NAME: {
            ...
            if ((ttFlagged & TI_CHECK_LABEL) != 0) {
                if (peekToken() == Token.COLON) {
                    ...
                    // XXX Better way?
                    return nf.createLabel(ts.getLineno(), ts.getTokenStart()); // <jgillick>
                }
            }
    ...
    private void plainProperty(ObjArray elems, Object property, int lineno, int offset) // <jgillick>
            throws IOException {
